package com.padc.eventbrite.activities;
...
import com.padc.eventbrite.adapters.EventListAdpater;

public class MainActivity extends AppCompatActivity {

    private RecyclerView rvEventList;
    private EventListAdpater mAdapter;
